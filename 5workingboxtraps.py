...
#Defaultzoom = 25 zooms på monitor med lenovopc (mulig telt feil og det er 26)
...
def move_to_start():
    ...
    #5box:
    random_x_interval = random.uniform(1351, 1359)
    ...
    #5box:
    random_y_interval = random.uniform(532, 539)
