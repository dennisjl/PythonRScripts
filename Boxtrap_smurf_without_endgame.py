...
#Defaultzoom = 19 from max zoom på monitor
#(the log er akkurat på full bilde)
#For monitor på smurf: 25 zooms ut fra bunn av.
#(Fordi ingen sliske endgame)
...
def move_to_start():
    random_x_interval = random.uniform(1426, 1448)
    random_y_interval = random.uniform(533, 548)
