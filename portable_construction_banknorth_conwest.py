...
#Camera angled north == up, bank to north and workbench on west
...
def move_to_bank():
    random_x_interval = random.uniform(849, 959)
    random_y_interval = random.uniform(172, 277)
...
def click_center_pwb():
    random_x_interval = random.uniform(497, 574)
    random_y_interval = random.uniform(442, 590)
